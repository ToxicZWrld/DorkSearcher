...
def logger(file: str, data: str) -> None:
    with open(file, "a", encoding="utf-8") as f:
        f.write(data + "\n")

def get_proxies_from_all_sources() -> list:
...
def validate_proxies(proxy_list: list, max_good: int = 30, threads: int = 50) -> list:
...
def dork_search(query: str, pages: int, proxy_pool: list, save: bool = False, filename: str = "results.txt") -> None:
    ...
    print(f"{Colors.BLUE}\n[✔] Total unique dorks fetched: {total}{Colors.RESET}")
